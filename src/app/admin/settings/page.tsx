...
const FIELDS: { column: string; label: string; kind: "text" | "number"; hint?: string }[] = [
  ...
  { column: "occupied_productivity_factor", label: "Occupied building productivity factor", kind: "number", hint: "Labour suggestions divide by this; 0.85 means about +18%" },
  { column: "collection_factor", label: "Collection factor", kind: "number", hint: "Internal cash strip only, 1.0 means full collection" },
  { column: "tiling_wall_uplift", label: "Tiling wall uplift AED", kind: "number", hint: "Added to the tiling labour suggestion for wall installation" },
