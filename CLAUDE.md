...
- Never print passwords, API keys or tokens in any message, report, chat output, log, commit or file outside .env.local. No exceptions, including summaries and handover notes. When an account needs a password, send a Supabase recovery link or have the user set it at /account/password or in the dashboard.
